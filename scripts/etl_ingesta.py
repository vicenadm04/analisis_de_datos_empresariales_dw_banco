...
def ejecutar_ingesta():
    ...
    for nombre_archivo in archivos:
        ...
        if entidad is None:
            print(f"⚠️ Ignorando {nombre_archivo}: No empieza con prestamos, clientes o sucursales.")
            continue
        ...
        try:
            ...
            # 4. Carga a Postgres
            df.write_database(
                table_name=f"staging.{tabla_nom}",
            ...
            print(f"✅ Cargado en staging.{tabla_nom} y movido a processed.")
